comment se servir des benchmarks de l'exercice 1 ?
...
executer le script ./benchmark.sh qui donnera les donnees pour le cas de base, le deroulage de i et l'option -funroll-loop
